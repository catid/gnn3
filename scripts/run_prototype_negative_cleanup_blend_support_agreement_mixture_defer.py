...
VARIANTS = ("prototype_negative_cleanup_blend_support_agree_mix", "prototype_negative_cleanup_blend_support_agree_mix_hybrid")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_negative_cleanup_blend_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_negative_cleanup_blend_support_agree_mix_hybrid"
    model = NegativeCleanupBlendSupportAgreementMixturePrototypeDeferHead(
...
def _plot(summary_df: pd.DataFrame, output_path: Path) -> None:
    ...
    axes[0].set_title("Negative-Cleanup Blend Precision vs Coverage")
    axes[1].set_title("Negative-Cleanup Blend Hard Near-Tie Delta Regret")
