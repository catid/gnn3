...
from gnn3.models.prototype_defer import Top2NegativeTailSupportAgreementMixturePrototypeDeferHead

KEY_COLS = ["suite", "episode_index", "decision_index"]
VARIANTS = ("prototype_top2_negative_tail_support_agree_mix", "prototype_top2_negative_tail_support_agree_mix_hybrid")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_top2_negative_tail_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_top2_negative_tail_support_agree_mix_hybrid"
    model = Top2NegativeTailSupportAgreementMixturePrototypeDeferHead(
...
def _plot(summary_df: pd.DataFrame, output_path: Path) -> None:
    ...
    axes[0].set_title("Top2 Negative-Tail Precision vs Coverage")
    axes[1].set_title("Top2 Negative-Tail Hard Near-Tie Delta Regret")
