...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_shared_sharp_negative_tail_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_shared_sharp_negative_tail_support_agree_mix_hybrid"
    model = SharedSharpNegativeTailSupportAgreementMixturePrototypeDeferHead(
...
def _plot(summary_df: pd.DataFrame, output_path: Path) -> None:
    ...
    axes[0].set_title("Shared-Sharp Negative-Tail Precision vs Coverage")
    axes[1].set_title("Shared-Sharp Negative-Tail Hard Near-Tie Delta Regret")
