...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_branch_strength_negative_cleanup_max_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_branch_strength_negative_cleanup_max_support_agree_mix_hybrid"
    model = BranchStrengthNegativeCleanupMaxSupportAgreementMixturePrototypeDeferHead(
...
def _plot(summary: pd.DataFrame, output_prefix: Path) -> None:
    ...
    ax.set_title("Branch-strength negative-cleanup max support agreement mixture")
