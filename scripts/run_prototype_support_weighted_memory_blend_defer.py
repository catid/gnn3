...
from gnn3.models.prototype_defer import SupportWeightedMemoryAgreementBlendPrototypeDeferHead

KEY_COLS = ["suite", "episode_index", "decision_index"]
VARIANTS = ("prototype_support_weighted_memory_blend", "prototype_support_weighted_memory_blend_hybrid")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_support_weighted_memory_blend_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_support_weighted_memory_blend_hybrid"
    model = SupportWeightedMemoryAgreementBlendPrototypeDeferHead(
...
def _plot(summary_df: pd.DataFrame, output_path: Path) -> None:
    ...
    axes[0].set_title("Support-Weighted Memory Blend Precision vs Coverage")
    axes[1].set_title("Support-Weighted Memory Blend Hard Near-Tie Delta Regret")
...
def main() -> None:
    ...
    models: dict[str, SupportWeightedMemoryAgreementBlendPrototypeDeferHead] = {}
