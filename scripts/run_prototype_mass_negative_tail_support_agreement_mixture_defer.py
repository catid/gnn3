...
VARIANTS = ("prototype_mass_negative_tail_support_agree_mix", "prototype_mass_negative_tail_support_agree_mix_hybrid")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_mass_negative_tail_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_mass_negative_tail_support_agree_mix_hybrid"
    model = MassAwareSharpNegativeTailSupportAgreementMixturePrototypeDeferHead(
...
def _plot(summary: pd.DataFrame, output_prefix: Path) -> None:
    ...
    ax.set_title("Mass-negative-tail support agreement mixture")
