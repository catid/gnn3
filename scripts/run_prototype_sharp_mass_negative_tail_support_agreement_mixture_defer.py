...
VARIANTS = ("prototype_sharp_mass_negative_tail_support_agree_mix", "prototype_sharp_mass_negative_tail_support_agree_mix_hybrid")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--tail-mass-center", type=float, default=0.5)
    parser.add_argument("--tail-mass-scale", type=float, default=4.0)
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_sharp_mass_negative_tail_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    tail_mass_center: float,
    tail_mass_scale: float,
    device: torch.device,
) -> SharpMassNegativeTailSupportAgreementMixturePrototypeDeferHead:
    use_risk = variant == "prototype_sharp_mass_negative_tail_support_agree_mix_hybrid"
    model = SharpMassNegativeTailSupportAgreementMixturePrototypeDeferHead(
        ...
        tail_mass_center=tail_mass_center,
        tail_mass_scale=tail_mass_scale,
    ).to(device)
    ...
    *,
    ...
    for variant in VARIANTS:
        model = _fit_head(
            ...
            tail_mass_center=args.tail_mass_center,
            tail_mass_scale=args.tail_mass_scale,
            device=device,
        )
...
def _plot(summary: pd.DataFrame, output_prefix: Path) -> None:
    ...
    ax.set_title("Sharp-mass negative-tail support agreement mixture")
