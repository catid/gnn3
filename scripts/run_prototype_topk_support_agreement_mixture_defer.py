...
from gnn3.models.prototype_defer import TopKSupportAgreementMixturePrototypeDeferHead

KEY_COLS = ["suite", "episode_index", "decision_index"]
VARIANTS = ("prototype_topk_support_agree_mix", "prototype_topk_support_agree_mix_hybrid")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pool-topk", type=int, default=4)
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_topk_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_topk_support_agree_mix_hybrid"
    model = TopKSupportAgreementMixturePrototypeDeferHead(
...
def _plot(summary_df: pd.DataFrame, output_path: Path) -> None:
    ...
    axes[0].set_title("Top-K Support Agreement Precision vs Coverage")
    axes[1].set_title("Top-K Support Agreement Hard Near-Tie Delta Regret")
