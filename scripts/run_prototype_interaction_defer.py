...
from gnn3.models.prototype_defer import InteractionPrototypeDeferHead

KEY_COLS = ["suite", "episode_index", "decision_index"]
VARIANTS = ("prototype_interaction_hybrid", "prototype_interaction_gated")
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_interaction_defer",
...
def _fit_head(
    ...
    *,
    ...
    model = InteractionPrototypeDeferHead(
        ...
        gated=variant == "prototype_interaction_gated",
    ).to(device)
...
def _plot(summary_df: pd.DataFrame, output_path: Path) -> None:
    ...
    axes[0].set_title("Prototype-Interaction Precision vs Coverage")
    axes[1].set_title("Prototype-Interaction Hard Near-Tie Delta Regret")
