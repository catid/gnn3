...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_max_dual_teacher_rebuilt_negative_bank_rescue_weighted_anchored_dual_lift_branchwise_max_negative_cleanup_support_agreement_mixture_defer",
...
def _rebuild_model(
    ...
    *,
    ...
    rebuilt_model = MaxDualTeacherRebuiltNegativeBankRescueWeightedAnchoredDualLiftBranchwiseMaxNegativeCleanupSupportAgreementMixturePrototypeDeferHead(
        feature_dim=train_features.size(1),
    ...
    *,
    ...
    for variant in VARIANTS:
        ...
        base_model = _fit_head(
            ...
            train_target,
            train_weights,
            torch.as_tensor(train_meta["harmful_teacher_bank_case"].to_numpy(copy=True), dtype=torch.bool),
...
def _plot(summary: pd.DataFrame, output_prefix: Path) -> None:
    ...
    ax.set_title("Max dual teacher-rebuilt rescue-weighted anchored dual-lift branchwise-max")
