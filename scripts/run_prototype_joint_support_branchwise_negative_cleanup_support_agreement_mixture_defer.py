...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--output-prefix",
        default="reports/plots/prototype_joint_support_branchwise_negative_cleanup_support_agreement_mixture_defer",
...
def _fit_head(
    ...
    *,
    ...
    use_risk = variant == "prototype_joint_support_branchwise_negative_cleanup_support_agree_mix_hybrid"
    model = JointSupportBranchwiseNegativeCleanupSupportAgreementMixturePrototypeDeferHead(
