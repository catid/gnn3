...
def _train_one_epoch(
    ...
    *,
    ...
    epoch_totals = {
        ...
        "poly_constructor_loss": 0.0,
        "self_improve_loss": 0.0,
...
def evaluate_decision_dataset(
    ...
    *,
    ...
    path_soft_target_weight: float,
    path_soft_target_temperature: float,
    path_soft_target_on_time_bonus: float,
    selection_pairwise_weight: float,
    selection_pairwise_temperature: float,
    ...
    poly_constructor_weight: float,
    poly_on_time_bonus: float,
    poly_slack_bonus: float,
    poly_hard_slack_ratio: float,
    poly_packet_min: int,
    self_improve_weight: float,
    self_improve_top_k: int,
    self_improve_on_time_bonus: float,
    self_improve_slack_bonus: float,
    self_improve_hard_slack_ratio: float,
    self_improve_packet_min: int,
) -> dict[str, float]:
    ...
    for batch in loader:
        ...
        losses = compute_losses(
            ...
            path_soft_target_weight=path_soft_target_weight,
            path_soft_target_temperature=path_soft_target_temperature,
            path_soft_target_on_time_bonus=path_soft_target_on_time_bonus,
            selection_pairwise_weight=selection_pairwise_weight,
            selection_pairwise_temperature=selection_pairwise_temperature,
            ...
            poly_constructor_weight=poly_constructor_weight,
            poly_on_time_bonus=poly_on_time_bonus,
            poly_slack_bonus=poly_slack_bonus,
            poly_hard_slack_ratio=poly_hard_slack_ratio,
            poly_packet_min=poly_packet_min,
            self_improve_weight=self_improve_weight,
            self_improve_top_k=self_improve_top_k,
            self_improve_on_time_bonus=self_improve_on_time_bonus,
            self_improve_slack_bonus=self_improve_slack_bonus,
            self_improve_hard_slack_ratio=self_improve_hard_slack_ratio,
            self_improve_packet_min=self_improve_packet_min,
        )
